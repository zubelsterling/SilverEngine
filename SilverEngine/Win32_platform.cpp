/*
Game engine written following totorial: https://www.youtube.com/watch?v=PJmpOhk9GXw
*/
...
int WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR, int nShowCmd) {
